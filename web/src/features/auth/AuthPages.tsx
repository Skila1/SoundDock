      ...
      <div className="w-full max-w-sm space-y-4 rounded-2xl border border-border bg-surface-1 p-8 shadow-card">
        <div className="mb-2 text-center">
          ...
          <p className="text-sm text-muted">
            {discordConfigured ? "Use Discord, or a username and password if an administrator created one." : "Sign in with the administrator account created at setup."}
          </p>
        </div>
        {(err || localErr) && (
  ...
  return (
    <div className="flex min-h-dvh items-center justify-center bg-background p-4">
      <div className="w-full max-w-sm space-y-4 rounded-2xl border border-border bg-surface-1 p-8 shadow-card">
        <div className="mb-2 text-center">
          <Logo className="mx-auto mb-4 h-28 w-auto" />
          <h1 className="text-xl font-semibold">Create administrator</h1>
          <p className="text-sm text-muted">Discord is off. This account is the first administrator.</p>
        </div>
